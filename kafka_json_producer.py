...
FILE_PATH = "D:\BIG_DATA\I neuron\Confluent-Kafka-Setup-main\Confluent-Kafka-Setup-main\cardekho_dataset.csv"
...
SSL_MACHENISM = 'PLAIN'
SCHEMA_REGISTRY_API_KEY = 'PKNOV6W4DQ5AP75E'
SCHEMA_REGISTRY_API_SECRET = 'YCKh4jB9M7g9otNPlZS9HuDJ8YbFoQFuu1shPuQ0r2XNwleUg2C9E69yop63ucOX'
    ...
    try:
        for car in get_car_instance(file_path=FILE_PATH):
            ...
            producer.produce(topic=topic,
                            # if we put a fixed string instead of str(uuid4()) like "tanuj " it will put in fixed partition. 
